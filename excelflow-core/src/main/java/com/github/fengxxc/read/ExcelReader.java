...
public class ExcelReader {
    ...
    public void proccess(BiConsumer<Integer, Object> cellCallback) throws IOException, InvalidFormatException, ParserConfigurationException, SAXException {
        ...
        while (sheets.hasNext()) {
            ...
            processSheet(sheets.getSheetName(), sheet, sst, stylesTable, this.sheet2CellTreeMap, cellCallback);
            sheet.close();
        }
    }

    private static void processSheet(String sheetName, InputStream sheet, SharedStringsTable sst, StylesTable stylesTable, Map<String, RTreeNode<CellMapper>> sheet2CellTreeMap, BiConsumer<Integer, Object> cellCallback) throws ParserConfigurationException, SAXException, IOException {
        ExcelFlowSaxHandler handler = new ExcelFlowSaxHandler(sheetName, sst, sheet2CellTreeMap, cellCallback);
